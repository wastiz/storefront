...
export default {
  ...
  'Industrial Components and Materials': 'Industrial Components and Materials',
  'Quality products for your projects': 'Quality products for your projects',
  'Installation materials': 'Installation materials',
  'Cable ties, ducts, fasteners': 'Cable ties, ducts, fasteners',
  'Industrial Products': 'Industrial Products',
  'Motors, drives, sensors': 'Motors, drives, sensors',
  'Electrical components': 'Electrical components',
  'Switches, relays, connectors': 'Switches, relays, connectors',
  'Power supplies': 'Power supplies',
  'Transformers, UPS, batteries': 'Transformers, UPS, batteries',
  'Control and signaling': 'Control and signaling',
  'PLC, HMI, indicators': 'PLC, HMI, indicators',
  'Measuring devices': 'Measuring devices',
  'Multimeters, sensors, gauges': 'Multimeters, sensors, gauges',
  'Enclosures': 'Enclosures',
  'Boxes, cabinets, panels': 'Boxes, cabinets, panels',
  'Cables': 'Cables',
  'Power, control, fiber optic': 'Power, control, fiber optic',
};
